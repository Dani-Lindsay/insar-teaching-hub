...
For a clearer picture of where the main processing chains came from, see the [Getting Started](getting-started.md) page for the foundational papers, and the [Keystone Papers](literature/keystone-papers.md) table for the most widely-cited studies.
